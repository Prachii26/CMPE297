...
// The composer is likely contenteditable, not a real <textarea placeholder=...>.
const textbox = page.getByRole('textbox').first()
console.log('textbox count:', await page.getByRole('textbox').count())
await textbox.click()
await textbox.fill('Use your shell tool to print 2+2, then tell me the result in one sentence.')
